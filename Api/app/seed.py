...
AREAS: list[tuple[str, str]] = [
    # (en, ar) — slug is derived from the English name. Every residential,
    # industrial and island area of the six governorates, in governorate order,
    # so the storefront's area picker browses the whole country rather than the
    # handful of areas that happen to have a listing today.
    ...
    ("Abdullah Al-Salem Suburb", "ضاحية عبد الله السالم"),
    ("Nuzha", "النزهة"),
    ("Faiha", "الفيحاء"),
    ("Qadsiya", "القادسية"),
    ("Rawda", "الروضة"),
    ...
    ("Shuwaikh Health District", "الشويخ الصحية"),
    ("Surra", "السرة"),
    ("Qortuba", "قرطبة"),
    ("Yarmouk", "اليرموك"),
    ...
    ("Sour Gardens", "حدائق السور"),
    ("Sawaber", "الصوابر"),
    ("Salhiya", "الصالحية"),
    ("Watiya", "الوطية"),
    ("Failaka", "فيلكا"),
    ("Auhha Island", "جزيرة عوهة"),
    ("Miskan Island", "جزيرة مسكان"),
    ("Umm Al-Namil Island", "جزيرة أم النمل"),
    ("Hawally", "حولي"),
    ("Salmiya", "السالمية"),
    ("Rumaithiya", "الرميثية"),
    ("Jabriya", "الجابرية"),
    ...
    ("Ministries Zone", "منطقة الوزارات"),
    ("Farwaniya", "الفروانية"),
    ("Khaitan", "خيطان"),
    ("South Khaitan", "جنوب خيطان"),
    ("Jleeb Al-Shuyoukh", "جليب الشيوخ"),
    ("Ardiya", "العارضية"),
    ("Ardiya Craft Zone", "العارضية الحرفية"),
    ...
    ("Shadadiya", "الشدادية"),
    ("Shadadiya Industrial", "الشدادية الصناعية"),
    ("Sabah Al-Salem University City", "جامعة صباح السالم"),
    ("Airport Zone", "منطقة المطار"),
    ...
    ("Julaia", "الجليعة"),
    ("Khiran", "الخيران"),
    ("Khiran Residential", "الخيران السكنية"),
    ("Khiran City", "مدينة الخيران"),
    ("Sabah Al-Ahmad Sea City", "مدينة صباح الأحمد البحرية"),
    ("Sabah Al-Ahmad", "صباح الأحمد"),
    ("Wafra", "الوفرة"),
    ("Wafra Residential", "الوفرة السكنية"),
    ("Nuwaiseeb", "النويصيب"),
    ("Maqwa", "المقوع"),
    ("Ahmadi Desert", "بر الأحمدي"),
    ("Jahra", "الجهراء"),
    ("Waha", "الواحة"),
    ("Oyoun", "العيون"),
    ("Qasr", "القصر"),
    ...
    ("Shagaya", "الشقايا"),
    ("Rawdatain", "الروضتين"),
    ("Umm Al-Aish", "أم العيش"),
    ("Jahra Desert", "بر الجهراء"),
    ("Jahra Industrial Craft Zone", "الجهراء الصناعية الحرفية"),
    ...
    ("Masayel", "المسايل"),
    ("Sabhan", "صبحان"),
    ("Sabhan Industrial", "صبحان الصناعية"),
    ("Wusta", "الوسطى"),
    ("West Abu Ftaira Craft Zone", "غرب أبو فطيرة الحرفية"),
]
...
SETTINGS: list[tuple[str, str]] = [
    ...
    ("site.snapchat", "kwt25_realestate"),
    ("site.name_ar", "Kwt25"),
    ("site.name_en", "Kwt25"),
]
