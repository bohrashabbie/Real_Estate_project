...
export default function NotFound() {
  ...
  return (
    <div className="mx-auto flex max-w-(--container-site) flex-col items-center px-4 py-24 text-center sm:px-6">
      <span className="flex h-16 w-16 items-center justify-center bg-cream-100 text-gold">
      ...
      <Link
        href="/properties"
        className="mt-8 inline-flex items-center gap-2 bg-navy px-6 py-3 text-sm font-bold text-cream shadow-card transition-colors hover:bg-navy-700"
      >
        {t("cta")}
